      ...
      <div class="tab-pane fade show in active" id="panel31" role="tabpanel">
        ...
        <div class="row" id="bookRow">
          ...
          <!-- Grid column -->
			 	...
			 	<c:set var="i" value="0" />
		  		<c:forEach var="book" items="${product}" end="7">
            ...
            <button type="button" class="btn btn-brown" id="button" value="${i}">more</button >
		  		...
		  		<c:forEach var="book" items="${product}">
					<c:set var="k" value="${k+1}"/>
						<input type="hidden" id="thumbnail${k}" value="${product.prodThumbnail}">
						<input type="hidden" id="author${k}" 	value="${product.author}">
						<input type="hidden" id="prodName${k}" 	value="${product.prodName}">
						<input type="hidden" id="prodNo${k}" 	value="${product.prodNo}">
				</c:forEach>
